...
/**
 * Text fields only for EXPERIENCED personal details submission.
 * Documents (aadhaarCard, experienceCertificate, leavingLetter)
 * come as separate MultipartFile parts in the same request.
 *
 * Frontend sends:
