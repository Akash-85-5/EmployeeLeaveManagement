//package com.example.employeeLeaveApplication.feature.meeting.repository;
//
...
//AND m.status = MeetingStatus.PENDING
//""")
...
//      AND m.status NOT IN (MeetingStatus.CANCELLED,MeetingStatus.REJECTED
//      )
