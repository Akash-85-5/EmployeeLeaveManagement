...
import com.example.employeeLeaveApplication.repository.AnnualLeaveMonthlyBalanceRepository;
...
public class AnnualLeaveBalanceService {
    ...
    public void deductLeave(Long employeeId, int year, int month, double days) {
        ...
        if (newRemaining < 0) {
            throw new com.example.employeeLeaveApplication.exceptions.BadRequestException(
