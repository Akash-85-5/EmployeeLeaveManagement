...
/**
 * Stores every approval / rejection action taken on an OD request.
 * Mirrors LeaveApproval exactly — one record per decision per level.
 * Concept #7: All process steps are stored for full audit trail.
 */
@Entity
